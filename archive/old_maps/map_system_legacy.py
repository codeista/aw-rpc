...
AIRPORT:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,AIRPORT:BLUE''', "Naval Units Test Map")
...
PLAIN,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,PLAIN
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
FACTORY:RED,PLAIN,CITY,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY,PLAIN,FACTORY:BLUE
BASE_TOWER_1:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,BASE_TOWER_1:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN
AIRPORT,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,AIRPORT
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
...
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
BASE_TOWER_1:RED,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,BASE_TOWER_1:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
CITY:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
...
CITY:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY:BLUE''', "Transport Test Map")
        ...
        # Note: Test maps from test_map_templates.py are now handled by the new MapParserV2 system
        # They use slot-based format which is not compatible with the legacy Map.parse method
        # The GameFactory.create_game_with_map_data() method should be used instead
