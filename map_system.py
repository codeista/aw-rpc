...
FACTORY:GREEN,PLAIN,CITY,PLAIN,FACTORY:YELLOW''', "Elimination Test - Small")
        ...
        # 7. COM_TOWER test map
        self._maps['com_tower_test'] = Map.parse('''RED,BLUE
FACTORY:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,FACTORY:BLUE
PLAIN,COM_TOWER,PLAIN,PLAIN,PLAIN,COM_TOWER,PLAIN,PLAIN
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
BASE_TOWER_1:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,BASE_TOWER_1:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
PLAIN,COM_TOWER,PLAIN,PLAIN,PLAIN,COM_TOWER,PLAIN,PLAIN
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
CITY:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY:BLUE''', "COM_TOWER Test Map")
        
        # Naval units test map - lots of water with some shoals and ports
        self._maps['naval_test'] = Map.parse('''RED,BLUE
PORT:RED,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,PORT:BLUE
SEA,SEA,SEA,SEA,REEF,SEA,SEA,REEF,SEA,SEA,SEA,SEA
SEA,SEA,REEF,SEA,SEA,SEA,SEA,SEA,SEA,REEF,SEA,SEA
...
FACTORY:RED,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,FACTORY:BLUE
BASE_TOWER_1:RED,PLAIN,MOUNTAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,MOUNTAIN,PLAIN,BASE_TOWER_1:BLUE
AIRPORT:RED,PLAIN,PLAIN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,PLAIN,PLAIN,AIRPORT:BLUE''', "Naval Units Test Map")
        
        # Air units test map - variety of terrain for defense testing
        self._maps['air_test'] = Map.parse('''RED,BLUE
AIRPORT:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,AIRPORT:BLUE
PLAIN,MOUNTAIN,WOOD,PLAIN,CITY,PLAIN,PLAIN,CITY,PLAIN,WOOD,MOUNTAIN,PLAIN
PLAIN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,PLAIN
FACTORY:RED,PLAIN,CITY,PLAIN,MISSILE_SILO,PLAIN,PLAIN,MISSILE_SILO,PLAIN,CITY,PLAIN,FACTORY:BLUE
BASE_TOWER_1:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,BASE_TOWER_1:BLUE
PLAIN,MOUNTAIN,PLAIN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,PLAIN,MOUNTAIN,PLAIN
PLAIN,PLAIN,CITY,PLAIN,PLAIN,COM_TOWER,COM_TOWER,PLAIN,PLAIN,CITY,PLAIN,PLAIN
AIRPORT,PLAIN,PLAIN,PLAIN,MOUNTAIN,PLAIN,PLAIN,MOUNTAIN,PLAIN,PLAIN,PLAIN,AIRPORT
PLAIN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,PLAIN
PORT:RED,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,PORT:BLUE''', "Air Units Test Map")
        
        # Land units test map - varied terrain for all ground units
        self._maps['land_test'] = Map.parse('''RED,BLUE
FACTORY:RED,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,FACTORY:BLUE
PLAIN,MOUNTAIN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,MOUNTAIN,PLAIN
PLAIN,WOOD,PLAIN,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,PLAIN,WOOD,PLAIN
BASE_TOWER_1:RED,PLAIN,ROAD_VERT,CITY,PLAIN,PLAIN,PLAIN,PLAIN,CITY,ROAD_VERT,PLAIN,BASE_TOWER_1:BLUE
PLAIN,PLAIN,ROAD_VERT,PLAIN,MOUNTAIN,PLAIN,PLAIN,MOUNTAIN,PLAIN,ROAD_VERT,PLAIN,PLAIN
CITY:RED,PLAIN,ROAD_VERT,PLAIN,PLAIN,COM_TOWER,COM_TOWER,PLAIN,PLAIN,ROAD_VERT,PLAIN,CITY:BLUE
PLAIN,WOOD,ROAD_SE,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_SW,WOOD,PLAIN
FACTORY,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,FACTORY
PLAIN,MOUNTAIN,PLAIN,WOOD,CITY,PLAIN,PLAIN,CITY,WOOD,PLAIN,MOUNTAIN,PLAIN
AIRPORT:RED,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,AIRPORT:BLUE''', "Land Units Test Map")
        
        # Comprehensive transport test map - mix of terrain types
        self._maps['transport_test'] = Map.parse('''RED,BLUE
PORT:RED,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,SEA,PORT:BLUE
SEA,SEA,SEA,SEA,REEF,SEA,SEA,REEF,SEA,SEA,SEA,SEA
SEA,SEA,REEF,SEA,SEA,SEA,SEA,SEA,SEA,REEF,SEA,SEA
BEACH_W,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_N,BEACH_E
FACTORY:RED,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,FACTORY:BLUE
BASE_TOWER_1:RED,PLAIN,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,ROAD_HORT,PLAIN,BASE_TOWER_1:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
AIRPORT:RED,PLAIN,WOOD,PLAIN,MOUNTAIN,PLAIN,PLAIN,MOUNTAIN,PLAIN,WOOD,PLAIN,AIRPORT:BLUE
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
CITY:RED,PLAIN,PLAIN,PLAIN,PLAIN,COM_TOWER,COM_TOWER,PLAIN,PLAIN,PLAIN,PLAIN,CITY:BLUE''', "Transport Test Map")
