...
MOUNTAIN,CITY,PLAIN,PLAIN,ROAD_VERT,WOOD,PLAIN,CITY,PLAIN,MOUNTAIN,RIVER_VERT,MOUNTAIN,PLAIN,WOOD,PLAIN,PLAIN,CITY,PLAIN,PLAIN,WOOD,ROAD_VERT,MOUNTAIN,RIVER_VERT,WOOD,PLAIN''', "Scorpion Operation")
        ...
        # 3-Player Triangle Arena
        self._maps['triangle'] = Map.parse('''RED,BLUE,GREEN
FACTORY:RED,CITY:RED,PLAIN,WOOD,MOUNTAIN,PLAIN,WOOD,PLAIN,MOUNTAIN,WOOD,PLAIN,CITY:BLUE,FACTORY:BLUE
CITY:RED,BASE_TOWER_1:RED,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:BLUE,CITY:BLUE
PLAIN,WOOD,PLAIN,PLAIN,WOOD,MOUNTAIN,PLAIN,MOUNTAIN,WOOD,PLAIN,PLAIN,WOOD,PLAIN
WOOD,PLAIN,PLAIN,WOOD,PLAIN,ROAD_NW,ROAD_HORT,ROAD_NE,PLAIN,WOOD,PLAIN,PLAIN,WOOD
MOUNTAIN,PLAIN,WOOD,PLAIN,ROAD_NW,ROAD_SE,CITY,ROAD_SW,ROAD_NE,PLAIN,WOOD,PLAIN,MOUNTAIN
...
MOUNTAIN,PLAIN,WOOD,PLAIN,ROAD_SW,ROAD_NE,CITY,ROAD_NW,ROAD_SE,PLAIN,WOOD,PLAIN,MOUNTAIN
WOOD,PLAIN,PLAIN,WOOD,PLAIN,ROAD_SW,ROAD_HORT,ROAD_SE,PLAIN,WOOD,PLAIN,PLAIN,WOOD
PLAIN,WOOD,PLAIN,PLAIN,WOOD,MOUNTAIN,PLAIN,MOUNTAIN,WOOD,PLAIN,PLAIN,WOOD,PLAIN
CITY:GREEN,BASE_TOWER_1:GREEN,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:GREEN,CITY:GREEN
FACTORY:GREEN,CITY:GREEN,PLAIN,WOOD,MOUNTAIN,PLAIN,WOOD,PLAIN,MOUNTAIN,WOOD,PLAIN,CITY:GREEN,FACTORY:GREEN''', "Triangle Arena - 3 Players")

        # 4-Player Cross Battle
        self._maps['cross'] = Map.parse('''RED,BLUE,GREEN,YELLOW
FACTORY:RED,CITY:RED,PLAIN,WOOD,MOUNTAIN,PLAIN,PLAIN,PLAIN,MOUNTAIN,WOOD,PLAIN,CITY:BLUE,FACTORY:BLUE
CITY:RED,BASE_TOWER_1:RED,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:BLUE,CITY:BLUE
PLAIN,WOOD,PLAIN,PLAIN,PLAIN,ROAD_NW,ROAD_HORT,ROAD_NE,PLAIN,PLAIN,PLAIN,WOOD,PLAIN
WOOD,PLAIN,PLAIN,PLAIN,ROAD_NW,ROAD_SE,CITY,ROAD_SW,ROAD_NE,PLAIN,PLAIN,PLAIN,WOOD
MOUNTAIN,PLAIN,PLAIN,ROAD_NW,ROAD_SE,CITY,WOOD,CITY,ROAD_SW,ROAD_NE,PLAIN,PLAIN,MOUNTAIN
PLAIN,PLAIN,ROAD_NW,ROAD_SE,CITY,WOOD,MOUNTAIN,WOOD,CITY,ROAD_SW,ROAD_NE,PLAIN,PLAIN
PLAIN,PLAIN,ROAD_VERT,CITY,WOOD,MOUNTAIN,AIRPORT,MOUNTAIN,WOOD,CITY,ROAD_VERT,PLAIN,PLAIN
PLAIN,PLAIN,ROAD_SW,ROAD_NE,CITY,WOOD,MOUNTAIN,WOOD,CITY,ROAD_NW,ROAD_SE,PLAIN,PLAIN
MOUNTAIN,PLAIN,PLAIN,ROAD_SW,ROAD_NE,CITY,WOOD,CITY,ROAD_NW,ROAD_SE,PLAIN,PLAIN,MOUNTAIN
WOOD,PLAIN,PLAIN,PLAIN,ROAD_SW,ROAD_NE,CITY,ROAD_NW,ROAD_SE,PLAIN,PLAIN,PLAIN,WOOD
PLAIN,WOOD,PLAIN,PLAIN,PLAIN,ROAD_SW,ROAD_HORT,ROAD_SE,PLAIN,PLAIN,PLAIN,WOOD,PLAIN
CITY:YELLOW,BASE_TOWER_1:YELLOW,WOOD,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:GREEN,CITY:GREEN
FACTORY:YELLOW,CITY:YELLOW,PLAIN,WOOD,MOUNTAIN,PLAIN,PLAIN,PLAIN,MOUNTAIN,WOOD,PLAIN,CITY:GREEN,FACTORY:GREEN''', "Cross Battle - 4 Players")

        # 5-Player Pentagon Chaos
        self._maps['pentagon'] = Map.parse('''RED,BLUE,GREEN,YELLOW,GREY
FACTORY:RED,CITY:RED,PLAIN,WOOD,MOUNTAIN,WOOD,PLAIN,WOOD,MOUNTAIN,WOOD,PLAIN,CITY:BLUE,FACTORY:BLUE
CITY:RED,BASE_TOWER_1:RED,WOOD,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:BLUE,CITY:BLUE
PLAIN,WOOD,PLAIN,PLAIN,WOOD,ROAD_NW,ROAD_HORT,ROAD_NE,WOOD,PLAIN,PLAIN,WOOD,PLAIN
WOOD,PLAIN,PLAIN,ROAD_NW,ROAD_SE,CITY,AIRPORT,CITY,ROAD_SW,ROAD_NE,PLAIN,PLAIN,WOOD
...
PLAIN,CITY,ROAD_VERT,AIRPORT,CITY,MOUNTAIN,COM_TOWER,MOUNTAIN,CITY,AIRPORT,ROAD_VERT,CITY,PLAIN
WOOD,PLAIN,ROAD_SW,ROAD_NE,WOOD,CITY,MOUNTAIN,CITY,WOOD,ROAD_NW,ROAD_SE,PLAIN,WOOD
MOUNTAIN,PLAIN,WOOD,ROAD_VERT,CITY,WOOD,CITY,WOOD,CITY,ROAD_VERT,WOOD,PLAIN,MOUNTAIN
WOOD,PLAIN,PLAIN,ROAD_SW,ROAD_NE,CITY,AIRPORT,CITY,ROAD_NW,ROAD_SE,PLAIN,PLAIN,WOOD
PLAIN,WOOD,PLAIN,PLAIN,WOOD,ROAD_SW,ROAD_HORT,ROAD_SE,WOOD,PLAIN,PLAIN,WOOD,PLAIN
CITY:GREY,BASE_TOWER_1:GREY,WOOD,PLAIN,PLAIN,PLAIN,CITY,PLAIN,PLAIN,PLAIN,WOOD,BASE_TOWER_1:GREEN,CITY:GREEN
FACTORY:GREY,CITY:GREY,PLAIN,WOOD,MOUNTAIN,WOOD,PLAIN,WOOD,MOUNTAIN,WOOD,PLAIN,CITY:GREEN,FACTORY:GREEN
PLAIN,PLAIN,PLAIN,PLAIN,PLAIN,CITY:YELLOW,BASE_TOWER_1:YELLOW,CITY:YELLOW,PLAIN,PLAIN,PLAIN,PLAIN,PLAIN
